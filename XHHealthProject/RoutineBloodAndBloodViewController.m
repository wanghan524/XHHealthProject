...
- (void)loadRoutineBloodAndBloodkey{
    ...
    [self.routineBloodAndBloodOrderArray addObject:@{@"TTTTTTT":@"****"}];
...
- (void)requestRoutineBloodAndBloodInfoData{
    ...
    [WSRequestManager XHGetRequestParameters:@{@"_IDNumber":numberString} withMethodName:ROUTINEBLOODANDBLOOD SuccessRequest:^(id data) {
